...
function menu(){
  ...
  const items = role === 'admin'
    ? ['dashboard','control','clientes','informes','eventos','realizados','operarios','tarifas','operario','albaranes','passwords','config']
    : ['operario'];
...
async function renderApp(){
  ...
  const routes={dashboard:viewDashboard,control:viewDailyControl,clientes:viewClients,informes:viewReports,eventos:viewCalendar,realizados:viewRealizados,operarios:viewUsers,tarifas:viewRates,operario:viewOperario,albaranes:viewNotes,passwords:viewPasswords,config:viewConfig};
